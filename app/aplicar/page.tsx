      ...
      <main className="relative pt-16 overflow-hidden">
        ...
        <div className="container-narrow relative z-10 py-16 md:py-24">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold tracking-wide mb-6 border border-brand/40 bg-brand/10 text-brand uppercase">
              Solo para mujeres de 25-40 años
            </div>
            <p className="text-ink-muted mb-6 text-sm md:text-base">
              ¿Con poco tiempo y cansada de hacer dietas?
            </p>
            <h1
              className="font-black text-ink leading-[1.08] tracking-tight mb-5"
              style={{ fontSize: "clamp(2rem, 5vw, 3.4rem)" }}
            >
              Te ayudo a perder <span className="text-brand">+9 kg</span> en tiempo
          ...
          <div className="rounded-2xl bg-brand text-white text-center px-6 py-6 md:py-7 mb-12 max-w-xl mx-auto shadow-[0_8px_40px_rgba(28,160,227,0.25)]">
          ...
          <div className="max-w-2xl mx-auto mb-12">
            <p className="text-center font-black tracking-widest uppercase mb-4 text-brand"
            ...
            {vslId ? (
              ...
              <div className="aspect-video w-full rounded-2xl border border-line bg-gradient-to-br from-surface to-page flex flex-col items-center justify-center">
                ...
                <p className="text-ink-subtle text-xs mt-3 uppercase tracking-widest">Vídeo muy pronto</p>
              </div>
            )}
            <p className="text-center text-sm md:text-base text-ink-muted mt-5">
          ...
          <p className="text-center font-black tracking-wide uppercase mb-4 text-brand"
             style={{ fontSize: "clamp(1.1rem, 2.5vw, 1.6rem)" }}>
          ...
          <div className="rounded-2xl bg-brand text-white px-6 py-7 md:px-10 md:py-9 mt-14 max-w-xl mx-auto shadow-[0_8px_40px_rgba(28,160,227,0.25)]">
