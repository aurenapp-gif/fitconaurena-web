...
export default function PrivacidadPage() {
  return (
    <LegalLayout title="Política de privacidad" updated="13 de agosto de 2026">
      <h2 className="text-ink font-bold text-base">1. Responsable del tratamiento</h2>
      <p>{companyLine()}. Contacto: {COMPANY.email}.</p>

      <h2 className="text-ink font-bold text-base mt-4">2. Datos que tratamos</h2>
      <ul className="list-disc pl-5 flex flex-col gap-1">
        ...
        <li>Cuestionario inicial: fecha de nacimiento, altura, objetivos, hábitos y estado de salud declarado.</li>
      ...
      <h2 className="text-ink font-bold text-base mt-4">3. Finalidad y base jurídica</h2>
      ...
      <h2 className="text-ink font-bold text-base mt-4">4. Encargados del tratamiento</h2>
      ...
      <h2 className="text-ink font-bold text-base mt-4">5. Fotos de progreso</h2>
      ...
      <h2 className="text-ink font-bold text-base mt-4">6. Conservación</h2>
      ...
      <h2 className="text-ink font-bold text-base mt-4">7. Derechos</h2>
