...
export default function TerminosPage() {
  return (
    <LegalLayout title="Términos y condiciones" updated="13 de agosto de 2026">
      ...
      <p>El impago de cualquier cuota, con independencia de que el cobro corresponda a la empresa o a la entidad financiadora, constituye un <strong className="text-white">incumplimiento contractual</strong> por parte de la clienta y determinará el <strong className="text-white">vencimiento anticipado</strong> de todas las cuotas pendientes hasta completar los 12 meses del programa. La empresa quedará facultada para <strong className="text-white">exigir el pago íntegro del importe pendiente</strong> y para <strong className="text-white">emprender acciones legales por deuda</strong> —extrajudiciales y judiciales— hasta obtener su cobro efectivo.</p>
      <p>Se repercutirán además los <strong className="text-white">intereses de demora</strong> devengados desde la fecha de cada vencimiento, los <strong className="text-white">gastos de recobro</strong> (incluida la intervención de agencias de recuperación de deuda), las <strong className="text-white">costas judiciales</strong> y los <strong className="text-white">honorarios de abogado y procurador</strong> derivados del procedimiento. La deuda podrá comunicarse a ficheros de solvencia patrimonial en los términos previstos por la normativa aplicable.</p>
