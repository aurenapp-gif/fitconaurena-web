...
type Icono = "inicio" | "perfil" | "revisiones" | "avisos" | "mas" | "asistente" | "dudas" | "tecnica" | "herramientas" | "agenda" | "contratos" | "clientas" | "panel" | "leads" | "salir";
...
const LINEA: Record<Icono, JSX.Element> = {
  ...
  asistente: <><path d="M20.3 12.2c0 4-3.7 7.2-8.3 7.2-1 0-2-.15-2.9-.42L4.2 20.4l1.5-3.7A6.9 6.9 0 0 1 3.7 12.2c0-4 3.7-7.2 8.3-7.2s8.3 3.2 8.3 7.2z" /><path d="M8.6 12.1h.01M12 12.1h.01M15.4 12.1h.01" /></>,
...
const RESTO: Item[] = [
  { href: "/miembros/asistente", label: "Asistente", icon: "asistente" },
